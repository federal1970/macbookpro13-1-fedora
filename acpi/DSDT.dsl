 ...
 *     Signature        "DSDT"
 *     Length           0x00008467 (33895)
 *     Revision         0x02
 *     Checksum         0x91
 *     OEM ID           "APPLE "
 *     OEM Table ID     "MacBookP"
 *     OEM Revision     0x00130001 (1245185)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20140424 (538182692)
 */
DefinitionBlock ("", "DSDT", 2, "APPLE ", "MacBookP", 0x00130001)
{
    /*
    ...
    Name (WOWE, Zero)
    Name (TAPD, Zero)
    OperationRegion (GNVS, SystemMemory, 0x88F9CC18, 0x02C5)
    ...
    Scope (_SB)
    {
        ...
        {
             0x23, 0xF8, 0xDC, 0x18, 0x79, 0x00               // #...y.
        })
        Alias (PRSA, PRSB)
        Alias (PRSA, PRSC)
        Alias (PRSA, PRSD)
        ...
        Device (PCI0)
        {
            ...
            Name (BUF0, Buffer (0x01D4)
            {
                ...
                /* 01B8 */  0x87, 0x17, 0x00, 0x00, 0x0C, 0x03, 0x00, 0x00,  // ........
                /* 01C0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF,  // ........
                /* 01C8 */  0xAF, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 01D0 */  0xB0, 0xFE, 0x79, 0x00                           // ..y.
            })
            ...
            Device (IGPU)
            {
                ...
                Device (^^MEM2)
                {
                    ...
                    {
                        /* 0000 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x00, 0x00, 0x20,  // ....... 
                        /* 0008 */  0x00, 0x00, 0x20, 0x00, 0x86, 0x09, 0x00, 0x01,  // .. .....
                        /* 0010 */  0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x20, 0x00,  // ...@.. .
                        /* 0018 */  0x79, 0x00                                       // y.
                    })
            ...
            Device (LPCB)
            {
                ...
                Scope (\_SB)
                {
                    ...
                    Device (LNKA)
                    {
                        ...
                        {
                             0x23, 0xFA, 0xD4, 0x18, 0x79, 0x00               // #...y.
                        })
                        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                        {
                    ...
                    Device (LNKB)
                    {
                        ...
                        Name (_PRS, Buffer (0x06)  // _PRS: Possible Resource Settings
                        {
                             0x23, 0xFA, 0xD8, 0x18, 0x79, 0x00               // #...y.
                        })
                        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                        {
                ...
                Device (HPET)
                {
                    ...
                    Name (BUF0, Buffer (0x14)
                    {
                        ...
                        /* 0008 */  0x00, 0x01, 0x00, 0x00, 0xD0, 0xFE, 0x00, 0x40,  // .......@
                ...
                Device (LDRC)
                {
                    ...
                    Name (_UID, 0x02)  // _UID: Unique ID
                    Name (_CRS, Buffer (0x62)  // _CRS: Current Resource Settings
                    {
                        ...
                        /* 0048 */  0x47, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0x01, 0x01,  // G.......
                        /* 0050 */  0x47, 0x01, 0x00, 0x18, 0x00, 0x18, 0x01, 0xFF,  // G.......
                        /* 0058 */  0x47, 0x01, 0x00, 0x08, 0x00, 0x08, 0x01, 0x80,  // G.......
                        /* 0060 */  0x79, 0x00                                       // y.
                    })
                }
                ...
                Device (SMC)
                {
                    ...
                    {
                        /* 0000 */  0x47, 0x01, 0x00, 0x03, 0x00, 0x03, 0x01, 0x20,  // G...... 
                        /* 0008 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,  // ........
                        /* 0010 */  0x00, 0x00, 0x01, 0x00, 0x22, 0x40, 0x00, 0x79,  // ...."@.y
                        /* 0018 */  0x00                                             // .
                    })
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
            ...
            Device (SPI1)
            {
                ...
                {
                    /* 0000 */  0x89, 0x06, 0x00, 0x0D, 0x01, 0x17, 0x00, 0x00,  // ........
            ...
            Device (URT0)
            {
                ...
                Name (RBUF, Buffer (0x0B)
                {
                    /* 0000 */  0x89, 0x06, 0x00, 0x0D, 0x01, 0x14, 0x00, 0x00,  // ........
                    /* 0008 */  0x00, 0x79, 0x00                                 // .y.
                })
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                ...
                Device (SPIT)
                {
                    ...
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
                        Name (UBUF, Buffer (0x2F)
                        {
                            ...
                            /* 0008 */  0x00, 0x01, 0x09, 0x00, 0x00, 0x12, 0x7A, 0x00,  // ......z.
                            /* 0010 */  0x08, 0x00, 0x00, 0x00, 0x00, 0x5C, 0x5F, 0x53,  // .....\_S
                            /* 0018 */  0x42, 0x2E, 0x50, 0x43, 0x49, 0x30, 0x2E, 0x53,  // B.PCI0.S
                            /* 0020 */  0x50, 0x49, 0x31, 0x00, 0x89, 0x06, 0x00, 0x05,  // PI1.....
            ...
            Scope (URT0)
            {
                Device (BLTH)
                {
                    ...
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        {
                            /* 0000 */  0x8E, 0x22, 0x00, 0x01, 0x00, 0x03, 0x00, 0x35,  // .".....5
                            /* 0008 */  0x00, 0x01, 0x0A, 0x00, 0x00, 0xC2, 0x01, 0x00,  // ........
                            /* 0010 */  0x20, 0x00, 0x20, 0x00, 0x00, 0xC0, 0x5C, 0x5F,  //  . ...\_
                            /* 0018 */  0x53, 0x42, 0x2E, 0x50, 0x43, 0x49, 0x30, 0x2E,  // SB.PCI0.
                            /* 0020 */  0x55, 0x52, 0x54, 0x30, 0x00, 0x79, 0x00         // URT0.y.
                        })
                        Name (ABUF, Buffer (0x02)
                        {
                             0x79, 0x00                                       // y.
    ...
    Scope (_SB.PCI0)
    {
        Device (PDRC)
        {
            ...
            Name (BUF0, Buffer (0x0116)
            {
                ...
                /* 0070 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00,  // ........
                /* 0078 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x00, 0x00, 0xFD,  // ........
                /* 0080 */  0x00, 0x00, 0x00, 0x01, 0x86, 0x09, 0x00, 0x01,  // ........
                /* 0088 */  0x00, 0x00, 0x00, 0xFE, 0x00, 0x00, 0x01, 0x00,  // ........
                /* 0090 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x00, 0x01, 0xFE,  // ........
                /* 0098 */  0x00, 0x10, 0x00, 0x00, 0x86, 0x09, 0x00, 0x01,  // ........
                /* 00A0 */  0x00, 0x00, 0x02, 0xFE, 0x00, 0x60, 0x01, 0x00,  // .....`..
                /* 00A8 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x60, 0x03, 0xFE,  // .....`..
                /* 00B0 */  0x00, 0x60, 0x00, 0x00, 0x86, 0x09, 0x00, 0x01,  // .`......
                /* 00B8 */  0x00, 0xC0, 0x03, 0xFE, 0x00, 0x10, 0x00, 0x00,  // ........
                /* 00C0 */  0x86, 0x09, 0x00, 0x01, 0x00, 0xD0, 0x03, 0xFE,  // ........
                /* 00C8 */  0x00, 0x30, 0x08, 0x00, 0x86, 0x09, 0x00, 0x01,  // .0......
                /* 00D0 */  0x00, 0x00, 0x0C, 0xFE, 0x00, 0x00, 0x04, 0x00,  // ........
                /* 00D8 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x00, 0x10, 0xFE,  // ........
                /* 00E0 */  0x00, 0x00, 0x10, 0x00, 0x86, 0x09, 0x00, 0x01,  // ........
                /* 00E8 */  0x00, 0x00, 0x20, 0xFE, 0x00, 0x00, 0x20, 0x00,  // .. ... .
                /* 00F0 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x00, 0x40, 0xFE,  // ......@.
                /* 00F8 */  0x00, 0x00, 0x01, 0x00, 0x86, 0x09, 0x00, 0x01,  // ........
                /* 0100 */  0x00, 0x00, 0x41, 0xFE, 0x00, 0x00, 0x1F, 0x00,  // ..A.....
                /* 0108 */  0x86, 0x09, 0x00, 0x01, 0x00, 0x00, 0x60, 0xFE,  // ......`.
                /* 0110 */  0x00, 0x00, 0x20, 0x00, 0x79, 0x00               // .. .y.
            })
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
