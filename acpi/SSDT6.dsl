...
DefinitionBlock ("", "SSDT", 2, "APPLE ", "Xhci", 0x00001000)
{
    ...
    External (_SB_.PCI0.RP05.UPSB.DSB2.XHC2.MODU, IntObj)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Scope (\_SB.PCI0.XHC1)
        {
            ...
            {
                Local0 = \_SB.PCI0.RP05.UPSB.DSB2.XHC2.MODU /* External reference */
                Local1 = Zero
